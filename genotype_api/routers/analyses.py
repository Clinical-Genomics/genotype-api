...
def read_analyses(db: Session = Depends(get_session)):
    """Return all analyses."""
...
def read_analysis(analysis_id: int, db: Session = Depends(get_session)):
    """Return all analyses."""
...
def delete_analysis(analysis_id: int, db: Session = Depends(get_session)):
    """Return all analyses."""
